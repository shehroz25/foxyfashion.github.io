...
<form action="" method="post" enctype="multipart/form-data">
    <table align="center" width="100">
        ...
        <tr>
            ...
            <td colspan="7"><input type="text" name="product_cat" value="<?php echo $fetch_cat['cat_title'];?>" size="60" required/></td>
        </tr>
...
if(isset($_POST['edit_cat'])){
    ...
    if($edit_cat){
        echo"<script>alert('Product category has been updated succesfully!')</script>";
