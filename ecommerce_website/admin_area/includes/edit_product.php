...
<form action="" method="post" enctype="multipart/form-data">
    <table align="center" width="100">
        ...
        <tr>
            ...
            <td><textarea name="product_descp"  rows="10"><?php echo $fetch_edit['product_descp'];?></textarea></td>
        </tr>
...
if(isset($_POST['edit_product'])){
    ...
    $update_product=mysqli_query($con,"update products set product_cat='$product_cat',product_title='$product_title',product_price='$product_price',product_descp='$product_descp',product_image='$product_image',date='$date' where product_id='$_GET[product_id]'");        
    }

    }else{
    $update_product=mysqli_query($con,"update products set product_cat='$product_cat',product_title='$product_title',product_price='$product_price',product_descp='$product_descp',date='$date' where product_id='$_GET[product_id]'");        
    }

    if($update_product){
        echo"<script>alert('product was updated succesfully!')</script>";
